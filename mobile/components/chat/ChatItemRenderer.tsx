...
interface ChatItemRendererProps {
  ...
  handleAddExpense: (matchId: string, amount: number, billImageUrl?: string | null, note?: string) => Promise<void>;
  handleEditExpense: (expenseId: string, amount: number, billImageUrl?: string | null, note?: string) => Promise<void>;
