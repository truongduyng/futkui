...
const rules = {
  ...
  groups: {
    bind: [
      ...
      "auth.id in data.ref('creator.user.id')",
      "isMember",
      "auth.id in data.ref('memberships.profile.user.id')",
    ],
    allow: {
      view: "true",
      create: "isAuthenticated",
  ...
  ledgerEntries: {
    ...
    allow: {
      view: "isGroupMember",
      create: "isAuthenticated && isGroupMember",
      delete: "isEntryOwner || isGroupAdmin",
      update: "isEntryOwner || isGroupAdmin",
    },
  },
  duesMembers: {
    bind: [
      ...
      "auth.id in data.ref('profile.user.id')",
      "isGroupMember",
      "auth.id in data.ref('duesCycle.group.memberships.profile.user.id')",
      "isGroupAdmin",
      "auth.id in data.ref('duesCycle.group.creator.user.id')",
    ],
    allow: {
      view: "isGroupMember",
      create: "isAuthenticated && isGroupMember",
      delete: "isMember || isGroupAdmin",
      update: "isMember || isGroupAdmin",
    },
  },
  errors: {
    bind: [
